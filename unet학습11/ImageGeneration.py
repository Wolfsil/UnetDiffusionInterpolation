...
imagePath = "/content/drive/MyDrive/unet학습11/test/test2.gif"
imageSavingPath = "/content/drive/MyDrive/unet학습11/generate/return.gif"
weightPath = "/content/drive/MyDrive/unet학습11/checkPoint/20_checkPoint.ckpt"
