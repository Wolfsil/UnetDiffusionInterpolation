...
pathTrain = "/content/drive/MyDrive/unet학습11/train/" + str(
    np.random.randint(1, 9) * 64
)  # 학습할 이미지
pathTest = "/content/drive/MyDrive/unet학습11/test"  # 벨리데이션 테스트 이미지
pathSave = "/content/drive/MyDrive/unet학습11/checkPoint/{epoch}_checkPoint.ckpt"  # 모델 저장할 위치
pathWeight = "/content/drive/MyDrive/unet학습11/checkPoint/20_checkPoint.ckpt"
