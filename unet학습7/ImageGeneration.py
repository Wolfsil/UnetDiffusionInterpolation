...
imagePath = "/content/drive/MyDrive/unet학습7/generate/tester.gif"
imageSavingPath = "/content/drive/MyDrive/unet학습7/generate/return.gif"
weightPath = "/content/drive/MyDrive/unet학습7/checkPoint/20_checkPoint.ckpt"
