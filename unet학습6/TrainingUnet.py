...
pathSave = (
    "/content/drive/MyDrive/unet학습6/checkPoint/{epoch}_checkPoint.ckpt"  # 모델 저장할 위치
)
pathWeight = "/content/drive/MyDrive/unet학습6/checkPoint/20_checkPoint.ckpt"
...
trainDataset = tf.data.Dataset.from_generator(
    ...
    output_shapes=(
        (None, None, None, 4),
        ((None, None, None, 4), (None, None, None, 4)),
    ),
)
