...
pathTrain = "/content/drive/MyDrive/unet학습13/train"  # 학습할 이미지
pathTest = "/content/drive/MyDrive/unet학습13/test"  # 벨리데이션 테스트 이미지
pathSave = "/content/drive/MyDrive/unet학습13/checkPoint"  # 모델 저장할 위치
pathWeight = "/content/drive/MyDrive/unet학습13/checkPoint/20-cp.ckpt"
