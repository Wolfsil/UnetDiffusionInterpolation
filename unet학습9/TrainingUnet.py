...
pathSave = (
    "/content/drive/MyDrive/unet학습9/checkPoint/{epoch}_checkPoint.ckpt"  # 모델 저장할 위치
)
pathWeight = "/content/drive/MyDrive/unet학습9/checkPoint/19_checkPoint.ckpt"
