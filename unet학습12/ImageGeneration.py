...
imagePath = "/content/drive/MyDrive/unet학습12/test/test2.gif"
imageSavingPath = "/content/drive/MyDrive/unet학습12/generate/return.gif"
weightPath = "/content/drive/MyDrive/unet학습12/checkPoint/20_checkPoint.ckpt"
